# Business Source License 1.1 — `cloud/` directory only

**This license applies ONLY to the `cloud/` directory.** The `core/` and `apps/`
directories are MIT licensed — see [LICENSE](LICENSE).
...
|---|---|
| **Licensor** | Notewise |
| **Licensed Work** | The contents of the `cloud/` directory of the Notewise repository |
| **Additional Use Grant** | You may use the Licensed Work for internal, non-production evaluation, development, and testing purposes without limitation. You may also deploy the Licensed Work in production for your own organization's internal use, provided you do not offer it to third parties as a hosted or managed service. |
| **Change Date** | Four years from the date each version is first published |
| **Change License** | Apache License, Version 2.0 |

> **Review note:** the Change Date and Change License above are conventional defaults.
> They should be reviewed against commercial intent before the first public release.
...
Licensed Work and the Change Date may vary for each version of the Licensed Work released
by Licensor.
...
The Business Source License is not an Open Source license. However, the Licensed Work will
